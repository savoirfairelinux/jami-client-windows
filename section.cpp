    ...
    ui(new Ui::SectionWidget)
{
    ...
    connect(ui->expandCollapseButton, &QAbstractButton::toggled, this, &SectionWidget::expandCollapseButtonToggled);
...
{
    ui->expandCollapseButton->setText(label);
}
...
void
SectionWidget::expandCollapseButtonToggled(bool checked)
{
    ...
    animationGroup_.setDirection(checked ? QAbstractAnimation::Forward : QAbstractAnimation::Backward);
