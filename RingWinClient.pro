...
maketranslationdir.input = ${QMAKE_FILE_PATH}
maketranslationdir.commands = $(MKDIR) -p ${QMAKE_FILE_PATH}/share/ring/translations/
maketranslationdir.output = ${QMAKE_FILE_PATH}/share/ring/translations/
...
QMAKE_EXTRA_COMPILERS += maketranslationdir updateqm
