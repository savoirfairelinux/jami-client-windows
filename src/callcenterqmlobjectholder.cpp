                                                    ...
                                                    const conversation::Info& convInfo)
{
    ...
    emit callContactImageChanged(contactImageFromCurrentConv(convInfo.uid), accountId, convInfo.uid);
...
QString
CallCenterQmlObjectHolder::contactImageFromCurrentConv(const QString& uid)
{
