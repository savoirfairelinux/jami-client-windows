...
CallWidget::registerShortCuts()
{
    ...
    auto maximizeScreenSC = new QShortcut(QKeySequence(tr("Ctrl+W", "Maximize Screen")), this);

    auto navigateToSettingsSC = new QShortcut(QKeySequence(tr("Ctrl+Right", "Navigate to settings")), this);
    ...
    connect(navigateToSettingsSC, &QShortcut::activated,
        [this] {
            emit NavigationRequested(ScreenEnum::SetttingsScreen);
        });
