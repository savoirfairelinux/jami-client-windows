...
protected:
    ...
    void initializeShaderResourceViewWithTexture(Microsoft::WRL::ComPtr<ID3D11Texture2D> texture,
                                                 ...
                                                 int index);
    void initializeTexture(Microsoft::WRL::ComPtr<ID3D11Texture2D> texture, Microsoft::WRL::ComPtr<ID3D11ShaderResourceView>
                           shaderResourceView, int width, int height, int index, D3D11_SUBRESOURCE_DATA resourceData);
    void initializeTextureWithCUDA(Microsoft::WRL::ComPtr<ID3D11Texture2D> texture, Microsoft::WRL::ComPtr<ID3D11ShaderResourceView>
                                   shaderResourceView, int width, int height, int lineSize, int index, CUdeviceptr startPtr, CUcontext cudaContext);
    bool updateTextureFromCUDA(AVFrame * frame);
protected:
    ...
    Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> shaderResourceViewD3DHW_;
    ...
    Microsoft::WRL::ComPtr<ID3D11Texture2D> texD3DHW_;
