...
protected:
    ...
    void initialize();
    void initializeTextures(ID3D11Texture2D* texture, ID3D11ShaderResourceView* shaderResourceView, int width, int height, int index, D3D11_SUBRESOURCE_DATA resourceData);
...
protected:
    ...
    ID3D11ShaderResourceView* shaderResourceViewY_;
    ID3D11ShaderResourceView* shaderResourceViewU_;
    ID3D11ShaderResourceView* shaderResourceViewV_;
    ID3D11Texture2D* texY_;
    ID3D11Texture2D* texU_;
    ID3D11Texture2D* texV_;
