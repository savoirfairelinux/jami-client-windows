...
protected:
    ...
    virtual void initializeTexture(QOpenGLTexture* texture, QOpenGLTexture::TextureFormat textureFormat, QOpenGLTexture::PixelFormat pixelFormat, int width, int height, uint8_t* data);
    virtual void initializeTextureWithCUDA(QOpenGLTexture* texture, QOpenGLTexture::TextureFormat textureFormat, int width, int height, int linesize, CUdeviceptr startPtr, CUcontext cudaContext);
