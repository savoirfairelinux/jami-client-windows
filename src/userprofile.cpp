    ...
    QmlPopupWidget(QUrl(QStringLiteral("")), parent)
{
    ...
    rootObject()->setProperty("userNameText", registeredName.isEmpty() ? "(None)" : registeredName);
    rootObject()->setProperty("registeredNameText", registeredName.isEmpty() ? name : registeredName);
