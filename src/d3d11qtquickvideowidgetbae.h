...
struct ConstantBufferDataStruct
{
    ...
    float roundedCornerRadius = 0.0f;
    bool isNV12 = false;
};
...
public:
    ...
    void setRoundedCornerRadius(float radius) {
        roundedCornerRadius_ = radius; if (renderer_) renderer_->constantBufferDataStruct_.roundedCornerRadius = radius;
    }
...
private:
    float roundedCornerRadius_ = 0.15f;
};
