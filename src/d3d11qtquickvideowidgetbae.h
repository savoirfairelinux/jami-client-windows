...
public:
    ...
    void setParantingQuickItem(QQuickItem* parent) { m_parantingItem = parent; }
...
private:
    ...
    const int texUIndex_ = 3;
    const int texVIndex_ = 4;
    const int texUV_NV12_Index_ = 5;
