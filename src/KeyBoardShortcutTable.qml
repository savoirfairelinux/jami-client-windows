        ...
        style: TabViewStyle {
            tab:Rectangle
            {
                ...
                Rectangle {
                    ...
                    radius: root.radius;
                    color: styleData.selected ? "#e0e0e0" :"#fdfdfd";
                    border.color: "white";
                }
                Text {
                    id: tabText;
                ...
                MouseArea {
                    ...
                    onReleased: { clipped.color = "#e0e0e0"; }
                    onEntered: { clipped.color = "#c7c7c7"; }
                    onExited: { clipped.color = Qt.binding(function() { return styleData.selected ? "#e0e0e0" :"#fdfdfd" }); }
                }
            }
