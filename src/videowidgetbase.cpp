...
GLVideoWidgetBase::paintGL()
{
    ...
    //glBindTexture(GL_TEXTURE_2D, frameTex_.Ytex->textureId());
    frameTex_.Ytex->bind(0);
    //glActiveTexture(GL_TEXTURE1);
    //glBindTexture(GL_TEXTURE_2D, frameTex_.Utex->textureId());
    frameTex_.Utex->bind(1);
    //glActiveTexture(GL_TEXTURE2);
    //glBindTexture(GL_TEXTURE_2D, frameTex_.Vtex->textureId());
...
GLVideoWidgetBase::updateTextures(AVFrame* frame)
{
    ...
    //glActiveTexture(GL_TEXTURE0);
    initializeTexture(frameTex_.Ytex, frame->width, frame->height, 0);
    ...
    //glActiveTexture(GL_TEXTURE1);
    initializeTexture(frameTex_.Utex, frame->width / 2, frame->height, 1);
