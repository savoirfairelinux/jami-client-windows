...
D3DVideoWidgetBase::InitScene()
{
    ...
    ERROR_HANDLE_RUN(D3DCompileFromFile(L"Effects.fx", 0, D3D_COMPILE_STANDARD_FILE_INCLUDE, "VS_main", "vs_4_0", 0, 0, &vertexShaderBlob_, 0),"Vertex shader compile fails");
    ERROR_HANDLE_RUN(D3DCompileFromFile(L"Effects.fx", 0, D3D_COMPILE_STANDARD_FILE_INCLUDE, "PS_main", "ps_4_0", 0, 0, &pixelShaderBlob_, 0),"Pixel shader compile fails");
