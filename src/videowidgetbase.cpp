...
D3DVideoWidgetWindow::updateTextureFromCUDA(AVFrame* frame)
{
    ...
    try {
        ...
        initializeTextureWithCUDA(texU_, shaderResourceViewU_, frame->width, frame->height / 2, frame->linesize[1],
                                  1, DXGI_FORMAT_R8G8_UNORM,  pointerToDataBufferUV, cudaContext);
