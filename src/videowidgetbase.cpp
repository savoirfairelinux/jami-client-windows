...
GLVideoWidgetBase::updateTextures(AVFrame* frame)
{
    ...
    //QImage yimg("C:/Users/wxdns/Desktop/test1.bmp");
    //QImage uimg("C:/Users/wxdns/Desktop/test2.bmp");
    //QImage vimg("C:/Users/wxdns/Desktop/test3.bmp");
    ...
    //frameTex_.Ytex->setData(yimg.mirrored());
    //frameTex_.Ytex->setData(0, 0, QOpenGLTexture::PixelFormat::Luminance, QOpenGLTexture::PixelType::UInt8, uimg.bits());
    ...
    //frameTex_.Utex->setData(uimg.mirrored());
    //frameTex_.Utex->setData(0, 0, QOpenGLTexture::PixelFormat::Luminance, QOpenGLTexture::PixelType::UInt8, uimg.bits() + uimg.width()* uimg.height());
    ...
    //frameTex_.Vtex->setData(vimg.mirrored());
    //frameTex_.Vtex->setData(0, 0, QOpenGLTexture::PixelFormat::Luminance, QOpenGLTexture::PixelType::UInt8, uimg.bits() + 2 * uimg.width() * uimg.height());
