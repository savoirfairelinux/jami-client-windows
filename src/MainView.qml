            ...
            TabBar {
                ...
                TabButton {
                    ...
                    background: Rectangle {
                        ...
                        radius: 10
                        color: pageOne.down ? ColorConstant.releaseColor : "white"
                        ...
                        MouseArea {
                            ...
                            onExited: { buttonRectOne.color = Qt.binding(function() { return pageOne.down ? ColorConstant.releaseColor : "white" }); }
                        }
                    }
                }
                TabButton {
                    ...
                    background: Rectangle {
                        ...
                        radius: 10
                        color: pageTwo.down ? ColorConstant.releaseColor : "white"
                        ...
                        MouseArea {
                            ...
                            onExited: { buttonRectTwo.color = Qt.binding(function() { return pageTwo.down ? ColorConstant.releaseColor : "white" }); }
                        }
                    }
                }
            }
