        ...
        Rectangle {
            ...
            ColumnLayout{
                ...
                Button {
                    ...
                    width: 100
                    height: 50
                    anchors.top: jamiLogoImage.bottom
                    anchors.topMargin: 10
                    anchors.left: jamiLogoImage.left
                    anchors.leftMargin: jamiLogoImage.width / 2 - changeLabelTextButton.width / 2
