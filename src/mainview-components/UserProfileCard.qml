                                        ...
                                        MenuItem {
                                            ...
                                            background: Rectangle {
                                                ...
                                                MouseArea {
                                                    ...
                                                    onReleased: { registeredNameContextMenuBackRect.color = "#e0e0e0"; qmlUtils.setText(registeredName.selectedText); reset();}
                                        ...
                                        MenuItem {
                                            ...
                                            background: Rectangle {
                                                ...
                                                MouseArea {
                                                    ...
                                                    onReleased: { idBackRect.color = "#e0e0e0"; qmlUtils.setText(idText.selectedText); reset();}
