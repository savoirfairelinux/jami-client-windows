...
MainApplication::qmlInitialization()
{
    ...
    QML_REGISTERTYPE(AccountComboBoxQmlObjectHolder, 1, 0);
    QML_REGISTERTYPE(CallCenterQmlObjectHolder, 1, 0);
    QML_REGISTERTYPE(CallOverlayQmlObjectHolder, 1, 0);
    QML_REGISTERTYPE(ConversationSmartListViewQmlObjectHolder, 1, 0);
    QML_REGISTERTYPE(ContactSearchBarQmlObjectHolder, 1, 0);
    ...
    QML_REGISTERSINGLETONTYPE_URL(QStringLiteral("qrc:/src/constant/JamiTheme.qml"),
                                  ...
                                  1,
                                  0);
    QML_REGISTERSINGLETONTYPE_URL(QStringLiteral("qrc:/src/mainview/components/CallCenter.qml"),
                                  Callcenter,
                                  1,
                                  0);
