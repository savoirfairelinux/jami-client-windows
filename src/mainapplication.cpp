...
MainApplication::qmlInitialization()
{
    ...
    qmlRegisterType<QmlClipboardAdapter>("Qt.tools.clipboard", 1, 0, "QClipboard");
    qmlRegisterType<QmlJamiVersionAdapter>("Qt.tools.version", 1, 0, "JamiVersion");
    qmlRegisterType<AccountListModel>("Qt.model.account", 1, 0, "AccountListModel");
    qmlRegisterSingletonType(QUrl(QStringLiteral("qrc:/src/ColorConstant.qml")), "Qt.constant.color", 1, 0, "ColorConstant");
