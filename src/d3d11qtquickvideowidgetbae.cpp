...
D3D11Renderer::mainPassRecordingStart()
{
    ...
    if (d3dDevContext_) {
        ...
        //d3dDevContext_->PSSetShaderResources(0, 1, shaderResourceViewY_.GetAddressOf());
        //d3dDevContext_->PSSetShaderResources(1, 1, shaderResourceViewU_.GetAddressOf());
        //d3dDevContext_->PSSetShaderResources(2, 1, shaderResourceViewV_.GetAddressOf());
        //d3dDevContext_->PSSetShaderResources(3, 1, shaderResourceViewNV12_.GetAddressOf());
