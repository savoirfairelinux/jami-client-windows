...
// image
QString getContactImageStringByConvUid(const QString& uid);
...
public:
    ...
    Q_INVOKABLE const QString getBestNameByConvUid(const QString& uid);
    Q_INVOKABLE const QString getBestIdByConvUid(const QString& uid);
