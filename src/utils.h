...
QImage scaleAndFrame(const QImage photo, const QSize& size = DEFAULT_IMAGE_SIZE);
QImage accountPhoto(const lrc::api::account::Info& accountInfo, const QSize& size = DEFAULT_IMAGE_SIZE);
