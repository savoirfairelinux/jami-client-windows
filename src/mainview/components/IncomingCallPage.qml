...
Window {
    ...
    function updateUI() {
        incomingCallPage.contactImgSource = "data:image/png;base64," + utilsAdapter.getContactImageStringByConvUid(responsibleConvUid)
        incomingCallPage.bestName = utilsAdapter.getBestNameByConvUid(responsibleConvUid)
        var id = utilsAdapter.getBestIdByConvUid(responsibleConvUid)
