...
Window {
    ...
    function refreshScreenShot() {
        screenShot.source = "data:image/png;base64," + AvAdapter.shootScreen(
                    screenNumber)
    }
    ...
    /*
     * Screen shot that will fill the entire screen,
    ...
    MouseArea {
        ...
        onReleased: {
            ...
            AvAdapter.displayArea(screenNumber, recSelect.x, recSelect.y,
