        ...
        Rectangle {
            ...
            CallOverlay {
                ...
                Connections {
                    ...
                    function onButtonStatusChanged(isPaused, isAudioOnly, isAudioMuted, isVideoMuted, isRecording, isSIP, isConferenceCall) {
                    ...
                    function onUpdateBestName(bestNameToBeUpdated) {
