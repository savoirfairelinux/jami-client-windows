    ...
    function setFormatListForDevice(device){
        ...
        try{
            ...
            for(var i=0; i < resolutions.length; i++){
                ...
                console.log("Number of formats:" + resolutions.length + " ; " + rates.length)
                console.log("Format: " + resolution +" [" + JSON.stringify(rate) +" fps]")
                // implement how to use formatBox to display them
            }
