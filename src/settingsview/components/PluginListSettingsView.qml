...
Rectangle {
    ...
    function openPreferencesPluginSlot(pluginName, pluginIcon, pluginId){
        updateAndShowPluginPreferenceSlot(pluginName, pluginIcon, pluginId)
    }

    function updateAndShowPluginPreferenceSlot(pluginName, pluginIcon, pluginId)
    {
            ...
            ListViewJami {
                ...
                delegate: PluginItemDelegate{
                    ...
                    onBtnPreferencesPluginClicked:{    
                        openPreferencesPluginSlot(pluginName, pluginIcon, pluginId)
                    }
                }
            }
        }
