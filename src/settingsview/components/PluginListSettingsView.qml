...
Rectangle {
    ...
    function uninstallPluginSlot(index){
        var pluginId = pluginItemListModel.data(pluginItemListModel.index(index,0), pluginItemListModel.PluginId)
