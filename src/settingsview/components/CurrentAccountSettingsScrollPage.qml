...
Rectangle {
    ...
    Connections {
        ...
        target: SettingsAdaptor.getContactModel()
    ...
    Connections {
        ...
        target: SettingsAdaptor.getDeviceModel()
    ...
    function setAccEnableSlot(state) {
        AccountAdapter.accoundModel().setAccountEnabled(UtilsAdapter.getCurrAccId(), state)
    }
