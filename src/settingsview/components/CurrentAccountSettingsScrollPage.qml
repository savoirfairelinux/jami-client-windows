...
Rectangle {
    ...
    property int regNameUi: CurrentAccountSettingsScrollWidget.BLANK
    ...
    function updateAccountInfoDisplayed(isTosetAvatar = true){
        ...
        accountEnableCheckBox.checked = accountInfo_Enabled
        displayNameLineEdit.text = accountInfo_ProfileInfo_Alias

        registeredIdNeedsSet = accountInfo_RegisteredName_Empty
    ...
    property string accountInfo_RegisteredName: SettingsAdaptor.get_CurrentAccountInfo_RegisteredName()
    property string accountInfo_ProfileInfo_Uri: SettingsAdaptor.getCurrentAccount_Profile_Info_Uri()
    property string accountInfo_ProfileInfo_Alias: SettingsAdaptor.getCurrentAccount_Profile_Info_Alias()

    property bool accountInfo_RegisteredName_Empty : accountInfo_RegisteredName === ""

    property var bannedContacts: contactModel.getBannedContacts()

    property string accountConfig_ManagerUri: SettingsAdaptor.getAccountConfig_Manageruri()
    property bool showLocalAccountConfig : accountConfig_ManagerUri === ""
    ...
    function setAvatar(){
        currentAccountAvatar.setAvatarPixmap(SettingsAdaptor.getAvatarImage_Base64(currentAccountAvatar.boothWidht),SettingsAdaptor.getIsDefaultAvatar())
    }
    ...
    function verifyRegisteredNameSlot(){
        if(!accountInfo_RegisteredName_Empty){
            regNameUi = CurrentAccountSettingsScrollPage.BLANK
        } else {
            registeredName = UtilsAdapter.stringSimplifier(currentRegisteredID.text)
            if(registeredName !==""){
            ...
            ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        ColumnLayout {
                            ...
                            InfoLineEdit {
                                ...
                                onEditingFinished: {
                                    AccountAdapter.setCurrAccDisplayName(displayNameLineEdit.text)
                                }
                            }
                        }
                    }
                    ...
                    ColumnLayout {
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                TextField {
                                    ...
                                    text: accountInfo_ProfileInfo_Uri
                            ...
                            RowLayout {
                                ...
                                RowLayout {
                                    ...
                                    TextField {
                                        ...
                                        text: {
                                            if(!registeredIdNeedsSet) return accountInfo_RegisteredName
                                        }
                                        ...
                                        background: Rectangle {
                                            ...
                                            color: registeredIdNeedsSet? Qt.rgba(240/256 , 240/256 , 240/256 ,1.0) : "transparent"
                                        }
                                    ...
                                    Label {
                                        ...
                                        visible: registeredIdNeedsSet && (regNameUi !== CurrentAccountSettingsScrollPage.BLANK)
                        ...
                        mipmap: true
                                    ...
                                    HoverableButton {
                                        ...
                                        visible: registeredIdNeedsSet && (regNameUi === CurrentAccountSettingsScrollPage.FREE)
                ...
                ColumnLayout {
                    ...
                    AdvancedSettingsView {
                        ...
                        onVisibleChanged: {
                            if(visible){
                                updateAccountInfoDisplayedAdvance()
                            }
                        }
                    }
                }
