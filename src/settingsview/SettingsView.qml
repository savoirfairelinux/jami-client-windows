...
Window {
    ...
    Component.onCompleted: {
        settingsViewQmlObjectHolder.setSettingsViewQmlObject(settingsViewWindow)
    }

    Item {
        SettingsViewQmlObjectHolder {
            id: settingsViewQmlObjectHolder
        }
    }
    ...
    Rectangle {
        ...
        property bool isSIP: settingsViewQmlObjectHolder.getIsSIP()
