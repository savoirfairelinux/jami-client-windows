...
private:
    AccountListModel* modelToProvide_;

public:
    AccountImageProvider(AccountListModel* modelToProvide) :
        QQuickImageProvider(QQuickImageProvider::Image, QQmlImageProviderBase::ForceAsynchronousImageLoading)
    {
        modelToProvide_ = modelToProvide;
    }
    ...
    QImage requestImage(const QString& id, QSize* size, const QSize& requestedSize) override
    {
        ...
        return modelToProvide_->data(modelToProvide_->index(indexPair.first, indexPair.second), AccountListModel::Role::Picture).value<QImage>();
    }
};