...
ColumnLayout {
    ...
    property int nameRegistrationUIState: NewWizardViewQmlObjectHolder.NameRegistrationUIState.BLANK
        ...
        RowLayout {
            ...
            Label {
                ...
                property string lookupStatusState: {
                    ...
                    case NewWizardViewQmlObjectHolder.NameRegistrationUIState.BLANK:
                        return "Blank"
                    case NewWizardViewQmlObjectHolder.NameRegistrationUIState.INVALID:
                        return "Invalid"
                    case NewWizardViewQmlObjectHolder.NameRegistrationUIState.TAKEN:
                        return "Taken"
                    case NewWizardViewQmlObjectHolder.NameRegistrationUIState.FREE:
                        return "Free"
                    case NewWizardViewQmlObjectHolder.NameRegistrationUIState.SEARCHING:
                        return "Searching"
                    default:
                        return "Blank"
                    }
