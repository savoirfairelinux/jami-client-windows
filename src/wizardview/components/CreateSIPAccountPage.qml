...
ColumnLayout {
    property alias sipFullNameEditAlias: sipFullNameEdit
    property alias sipServernameEditAlias: sipServernameEdit
    property alias sipProxyEditAlias: sipProxyEdit
    property alias sipUsernameEditAlias: sipUsernameEdit
    property alias sipPasswordEditAlias: sipPasswordEdit
