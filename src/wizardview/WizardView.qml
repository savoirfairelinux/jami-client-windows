    ...
    NewWizardViewQmlObjectHolder {
        ...
        function setNavBarVisibility(navVisible, back) {
            ...
            btnBack.visible = (back == true)
                    && (AccountModelAdapter.getAccountListSize() == true)
        }
        ...
        function processWizardInformationsQML() {
            ...
            case NewWizardViewQmlObjectHolder.CREATE:
                ...
                newWizardViewQmlObjectHolder.setInputParaHashPair(
                            "alias", createAccountPage.text_fullNameEditAlias)
                newWizardViewQmlObjectHolder.setInputParaHashPair(
                            "password",
            ...
            newWizardViewQmlObjectHolder.setInputParaHashPair("archivePath",
                                                              fileToImport)
        ...
        function changePageQML(pageIndex) {
            ...
            if (pageIndex == controlPanelStackView.welcomePageStackId) {
                ...
                newWizardViewQmlObjectHolder.setNavBarVisibility(true)
                importFromBackupPage.text_passwordFromBackupEditAlias.clear()
                newWizardViewQmlObjectHolder.fileToImport = ""
                btnNext.enabled = false
        ...
        function validateWizardProgressionQML() {
            if (controlPanelStackView.currentIndex
                ...
                var validManager = !(connectToAccountManagerPage.text_accountManagerEditAlias.length
                                     == 0)
            ...
            if (passwordOk
                ...
                createAccountPage.collapsiblePasswordWidgetAlias.displayState_passwordStatusLabelAlias = "Success"
            } else if (!passwordOk) {
                createAccountPage.collapsiblePasswordWidgetAlias.displayState_passwordStatusLabelAlias = "Fail"
            } else {
                createAccountPage.collapsiblePasswordWidgetAlias.displayState_passwordStatusLabelAlias = "Hide"
            }
