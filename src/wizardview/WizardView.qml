...
Window {
    ...
    Item {
        ...
        NewWizardViewQmlObjectHolder {
            ...
            onInputParaObjectChanged: {
                newWizardViewQmlObjectHolder.inputPara = JSON.stringify(
            ...
            function processWizardInformationsQML() {
                ...
                console.log(" Example object: " + JSON.stringify(
                                newWizardViewQmlObjectHolder.inputParaObject))

                //                console.log(JSON.stringify(
                //                                newWizardViewQmlObjectHolder.inputPara))
                //                for (var key in newWizardViewQmlObjectHolder.inputPara) {
                //                    console.log("Input para: key is " + JSON.stringify(
                //                                    key) + " , value is " + JSON.stringify(
                //                                    newWizardViewQmlObjectHolder.inputPara[key]))
                //                }
