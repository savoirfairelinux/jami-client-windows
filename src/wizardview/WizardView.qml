...
import net.jami.WizardViewAdapter 1.0
...
Window {
    ...
    Component.onCompleted: {
        wizardViewAdapter.setWizardViewAdapter(wizardViewWindow)

        wizardViewAdapter.changePageQML(
                    controlPanelStackView.welcomePageStackId)
    }

    Item {
        id: wizardViewAdapterWrapper
        ...
        Connections {
            ...
            onRegisteredNameFound: {
                wizardViewAdapter.slotRegisteredNameFound(status, address, name)
            }
        }
        ...
        Connections {
            ...
            onWelcomePageRedirectPage: {
                wizardViewAdapter.changePageQML(toPageIndex)
            }
        }
        ...
        Connections {
            ...
            onText_usernameEditAliasChanged: {
                ...
                wizardViewAdapter.validateWizardProgressionQML()
            }
        ...
        PasswordDialog {
            ...
            onAccepted: {
                wizardViewAdapter.exportToFile(LrcGeneralAdapter.getCurrAccId(
                                                   ), path + "/export.gz", "")
            }
            ...
            onDoneSignal: {
                if (currentPurpose === passwordDialog.ExportAccount) {
                    ...
                    if (success) {
                        ...
                        wizardViewAdapter.showMainViewWindow()
        ...
        Connections {
            ...
            onNeverShowAgainBoxClicked: {
                wizardViewAdapter.settingsNeverShowAgainBox(isChecked)
            }

            onExport_Btn_FileDialogAccepted: {
                if (accepted) {
                    // is there password? If so, go to password dialog, else, go to following directly
                    if (wizardViewAdapter.hasPassword()) {
                        ...
                        if (folderDir.length > 0) {
                            wizardViewAdapter.exportToFile(
        ...
        WizardViewAdapter {
            ...
            function createAccountQML() {
                ...
                case WizardView.IMPORT:
                    createJamiAccount(inputParaObject,
                ...
                RoundButton {
                    ...
                    onClicked: {
                        ...
                        if (controlPanelStackView.currentIndex
                                == controlPanelStackView.createAccountPageId) {
                            wizardMode = WizardView.CREATE
                            wizardViewAdapter.processWizardInformationsQML()
                        } else if (controlPanelStackView.currentIndex
                                   == controlPanelStackView.importFromDevicePageId) {
