...
WizardDialog::WizardDialog(bool wizardMode, QWidget* parent) :
    QDialog(parent),
...
WizardDialog::accept()
{
    ...
    if (ui->passwordEdit->text().isEmpty() || ui->passwordEdit->text() != ui->confirmPasswordEdit->text()) {
        ...
        ui->passwordEdit->setStyleSheet("border-color: rgb(192, 212, 0);");
        ui->confirmPasswordEdit->setStyleSheet("border-color: rgb(192, 212, 0);");
        ui->pinEdit->setStyleSheet("border-color: rgb(192, 212, 0);");
    }
