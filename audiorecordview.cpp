...
AudioRecordView::playAudio()
{
    ...
    audioPlayer_->setMedia(QUrl::fromLocalFile(recordedAudioFilePath_));
    audioPlayer_->setNotifyInterval(100);
    QObject::connect(audioPlayer_, &QMediaPlayer::mediaStatusChanged, this, &AudioRecordView::on_audioPlayFinish);
    QObject::connect(audioPlayer_, &QMediaPlayer::positionChanged,this,&AudioRecordView::on_audioPlayProgressUpdate);
    ...
    {
        qDebug() << "AudioRecorderView: The audio file is not playable";
    }
}
