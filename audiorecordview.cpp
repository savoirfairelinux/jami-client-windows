...
AudioRecordView::playAudio()
{
    ...
    QObject::connect(audioPlayer_, &QMediaPlayer::mediaStatusChanged, this, on_audioPlayFinish);
    QObject::connect(audioPlayer_, &QMediaPlayer::positionChanged,this,on_audioPlayProgressUpdate);
    if(audioPlayer_->isAudioAvailable())
    {
        // innitialize the time display
        currentTime_ = 0;
        // play the audio
        audioPlayer_->play();
    }
