...
FrequentDelegate::FrequentDelegate(QObject *parent) :
...
void
FrequentDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option,
...
QSize
FrequentDelegate::sizeHint(const QStyleOptionViewItem & option, const QModelIndex & index ) const
{
