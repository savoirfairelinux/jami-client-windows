    ...
    , ui(new Ui::AdvancedSIPSettingsWidget)
{
    ...
    connect(ui->lineEditSIPCertPassword, &QLineEdit::textChanged, this, &AdvancedSIPSettingsWidget::lineEditSIPCertPasswordLineEdit);
    connect(ui->outgoingTLSServerNameLineEdit, &QLineEdit::textChanged, this, &AdvancedSIPSettingsWidget::outgoingTLSServerNameLineEdit);
...
void
AdvancedSIPSettingsWidget::lineEditSIPCertPasswordLineEdit(const QString& text)
{
    auto confProps = LRCInstance::accountModel().getAccountConfig(LRCInstance::getCurrAccId());
