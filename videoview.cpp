...
VideoView::resizeEvent(QResizeEvent* event)
{
    ...
    previewRect.setWidth(width() / 5);
    previewRect.setHeight(height() / 5);
    previewRect.moveTo(width() - previewRect.width() - PreviewRenderWidget::previewMargin_,
                       height() - previewRect.height() - PreviewRenderWidget::previewMargin_);
