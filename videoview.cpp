    ...
    , ui(new Ui::VideoView)
{
    ...
    previewRenderer_ = new PreviewRenderWidget(this);

    auto previewInitialWidth = previewRenderer_->width() / 3;
    auto previewInitialHeight = previewRenderer_->height() / 3;
    previewRenderer_->setGeometry(this->width() - previewMargin_ - previewInitialWidth, this->height() - previewMargin_ - previewInitialHeight,
