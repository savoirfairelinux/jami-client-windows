...
InviteItemDelegate::InviteItemDelegate(QObject* parent) :
    QItemDelegate(parent)
{
}

void
InviteItemDelegate::paint(QPainter* painter
...
QSize
InviteItemDelegate::sizeHint(const QStyleOptionViewItem& option,
