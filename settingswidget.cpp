...
void SettingsWidget::leaveSettingsSlot()
{
    ...
    if (LRCInstance::getCurrentAccountInfo().profileInfo.type == lrc::api::profile::Type::SIP) {
        ...
        isPhotoBoothOpened = ui->currentAccountAvatar->isPhotoBoothOpened();
        // reset setting preview is not viewed
    ...
    if (previewed_ && !isPhotoBoothOpened) {
...
void SettingsWidget::startPreviewing(bool isDeviceChanged)
{
    ...
    else if (pastButton_ != Button::mediaSettingsButton && isPhotoBoothOpened) {
