...
void SettingsWidget::populateGeneralSettings()
{
    ...
    Utils::setElidedText(ui->downloadButton, QFileInfo(downloadPath).fileName(), Qt::ElideRight, 32);
    ...
    ui->recordPathButton->setText(QFileInfo(media::RecordingModel::instance().recordPath()).fileName());
