...
public:
     ...
     * @return error string
     */
    static PWSTR GetLastErrorAsPWSTR();
     ...
     * Get service name.
     */
    PWSTR getServiceName() { return serviceName_; }
...
protected:
    ...
    /**
     * Send a message to the application event log
     *
     * @param message - message to be sent
     * @param type - the type of event to be sent, it contains:
     *
     * EVENTLOG_SUCCESS
     ...
     */
    static void writeEventLogEntry(PWSTR serviceName, PWSTR message, WORD type);

    /**
     * Get the process handle that is specificied by processName
     *
     * @param currentServiceName - name of the calling service name that the event log is sent
     * @param processName - name of the process (executable)
     * @param hProcess - reference of the process handle
     *
     * https://docs.microsoft.com/en-us/windows/win32/toolhelp/taking-a-snapshot-and-viewing-processes
     */
    static BOOL findProcessHandle(PWSTR currentServiceName, std::wstring& processName, HANDLE& hProcess);
