    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->settingswidget, &SettingsWidget::videoDeviceChangedFromComboBox, this, &MainWindow::slotVideoDeviceChangedFromSettingsComboBox);
}
...
void MainWindow::slotVideoDeviceChangedFromSettingsComboBox(const std::string& device)
{
    Q_UNUSED(device;)
