    ...
    connect(&LRCInstance::instance(), &LRCInstance::accountListChanged,
        [this] {
            if (LRCInstance::accountModel().getAccountList().size()) {
                GlobalSystemTray::instance().contextMenu()->clear();
                GlobalSystemTray::instance().contextMenu()->addAction(settingsAction_);
                GlobalSystemTray::instance().contextMenu()->addAction(exitAction_);
            } else {
                GlobalSystemTray::instance().contextMenu()->removeAction(settingsAction_);
            }
        });
