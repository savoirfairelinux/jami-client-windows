...
$OutDir = $ClientDir + "\out"
New-Item -ItemType directory -Path $OutDir -Force

# daemon/contrib/client dep bin files
$FilesToCopy = @(
    "$ClientDir\winsparkle\x64\Release\WinSparkle.dll",
    "$ClientDir\..\daemon\contrib\build\ffmpeg\Build\win32\x64\bin\avcodec-58.dll",
    "$ClientDir\..\daemon\contrib\build\ffmpeg\Build\win32\x64\bin\avutil-56.dll",
    "$ClientDir\..\daemon\contrib\build\ffmpeg\Build\win32\x64\bin\avformat-58.dll",
    "$ClientDir\..\daemon\contrib\build\ffmpeg\Build\win32\x64\bin\avdevice-58.dll",
    "$ClientDir\..\daemon\contrib\build\ffmpeg\Build\win32\x64\bin\swresample-3.dll",
    "$ClientDir\..\daemon\contrib\build\ffmpeg\Build\win32\x64\bin\swscale-5.dll",
    "$ClientDir\..\daemon\contrib\build\ffmpeg\Build\win32\x64\bin\avfilter-7.dll",
    "$ClientDir\..\daemon\contrib\build\restbed\dependency\openssl\out32dll\libeay32.dll",
    "$ClientDir\..\daemon\contrib\build\restbed\dependency\openssl\out32dll\ssleay32.dll",
    "$ClientDir\winsparkle\x64\Release\WinSparkle.dll",
    "$ClientDir\ring.nsi",
...
# lrc translations
$lrcTSPath = "$ClientDir\..\lrc\translations"
