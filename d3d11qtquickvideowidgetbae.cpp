...
D3D11Renderer::mainPassRecordingStart()
{
    ...
    if(shaderResourceViewY_) d3dDevContext_->PSSetShaderResources(0, 1, shaderResourceViewY_.GetAddressOf());
    if (shaderResourceViewU_) d3dDevContext_->PSSetShaderResources(1, 1, shaderResourceViewU_.GetAddressOf());
    if (shaderResourceViewV_) d3dDevContext_->PSSetShaderResources(2, 1, shaderResourceViewV_.GetAddressOf());
    if (shaderResourceViewNV12_) d3dDevContext_->PSSetShaderResources(3, 1, shaderResourceViewNV12_.GetAddressOf());
