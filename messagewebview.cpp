...
MessageWebView::openAudioRecorder(int spikePosX, int spikePosY)
{
    ...
    auto recorderWidth = recordWidget_->getContainer()->size().width();
    auto recorderHeight = recordWidget_->getContainer()->size().height();
...
MessageWebView::openVideoRecorder(int spikePosX, int spikePosY)
{
    ...
    recordWidget_->setGeometry(pointOfVideoButton.x() - recorderWidth/2,
                               pointOfVideoButton.y() - recorderHeight,
                               recorderWidth, recorderHeight);
