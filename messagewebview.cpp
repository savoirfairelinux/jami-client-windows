...
{
    auto html = Utils::QByteArrayFromFile(QDir::currentPath() + "/../lrc/src/web-chatview/chatview.html");
    page()->setHtml(html, QUrl(QDir::currentPath() + "/../lrc/src/web-chatview/chatview.html"));
...
{
    insertStyleSheet("chatcss", Utils::QByteArrayFromFile(QDir::currentPath() + "/../lrc/src/web-chatview/chatview.css"));
    insertStyleSheet("chatwin",Utils::QByteArrayFromFile(QDir::currentPath() + "/../lrc/src/web-chatview/chatview-windows.css"));
    page()->runJavaScript(Utils::QByteArrayFromFile(QDir::currentPath() + "/../lrc/src/web-chatview/linkify.js"), QWebEngineScript::MainWorld);
    page()->runJavaScript(Utils::QByteArrayFromFile(QDir::currentPath() + "/../lrc/src/web-chatview/linkify-html.js"), QWebEngineScript::MainWorld);
    page()->runJavaScript(Utils::QByteArrayFromFile(QDir::currentPath() + "/../lrc/src/web-chatview/linkify-string.js"), QWebEngineScript::MainWorld);
    page()->runJavaScript(Utils::QByteArrayFromFile(QDir::currentPath() + "/../lrc/src/web-chatview/qwebchannel.js"), QWebEngineScript::MainWorld);
    page()->runJavaScript(Utils::QByteArrayFromFile(QDir::currentPath() + "/../lrc/src/web-chatview/chatview.js"), QWebEngineScript::MainWorld);
}
