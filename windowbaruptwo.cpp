...
,dl( QPoint() )
{
  ...
  contactslist_ = addAction(QIcon(":images/contactswidgetlist.png"), "contacts");
  
  contactslist_->setCheckable(true);
  
  history_ = addAction(QIcon(":images/historylist.png"), "history");
  ...
  settings_ = addAction(QIcon(":images/settings.png"), "settings");
...
void WindowBarUpTwo::mouseReleaseEvent(QMouseEvent *event)
{
	Q_UNUSED(event);
