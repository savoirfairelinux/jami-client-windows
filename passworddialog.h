...
public:
    ...
    Q_INVOKABLE bool savePassword(QVariant currentPasswordEditPassword, QVariant passwordEditPassword);
    Q_INVOKABLE bool exportAccount(QVariant currentPasswordEditPassword);
};