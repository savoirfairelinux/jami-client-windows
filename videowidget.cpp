        ...
        if (previewImage_) {
            if (resetPreview_) {
                ...
                if (photoMode_)
                    ...
                    scaledPreview = GetRoundedPhoto( previewImage_->scaled(previewWidth, previewHeight, Qt::KeepAspectRatio));
            ...
            if (photoMode_) {
                ...
                scaledPreview = GetRoundedPhoto(previewImage_->scaled(previewGeometry_.width(),
...
QImage VideoWidget::GetRoundedPhoto(const QImage original)
{
