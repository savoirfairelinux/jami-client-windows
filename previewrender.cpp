    ...
    , ui(new Ui::PreviewRenderWidget)
{
    ...
    connect(LRCInstance::getRenderDistributer(), &RenderDistributer::previewFrameReady,
        [this]() {
    ...
    connect(LRCInstance::getRenderDistributer(), &RenderDistributer::previewRenderingStopped,
        [this]() {
            QMutexLocker lock(&mutex_);
            previewRenderer_ = LRCInstance::getRenderDistributer()->getPreviewRenderer();
            previewFrame_ = LRCInstance::getRenderDistributer()->getPreviewFrame();
