    ...
    imDelegate_(new ImDelegate())
{
    ...
    try {
        ...
        connect(smartListModel_, &QAbstractItemModel::dataChanged, [=](const QModelIndex &topLeft, const QModelIndex &bottomRight,const QVector<int> &vec){
