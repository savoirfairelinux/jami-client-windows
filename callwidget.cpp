    ...
    imDelegate_(new ImDelegate())
{
    ...
    connect(ui->smartList, &SmartListView::btnAcceptInviteClicked, this, &CallWidget::slotAcceptInviteClicked);
    connect(ui->smartList, &SmartListView::btnBlockInviteClicked, this, &CallWidget::slotBlockInviteClicked);
    connect(ui->smartList, &SmartListView::btnIgnoreInviteClicked, this, &CallWidget::slotIgnoreInviteClicked);
    ...
    /*ui->buttonConversations->setTypeFilter(lrc::api::profile::Type::RING);
    ui->buttonInvites->setTypeFilter(lrc::api::profile::Type::PENDING);*/
...
{
    qDebug() << "slotAcceptInviteClicked: " << index.row();
}
...
CallWidget::updateSmartList()
{
    ...
    ui->smartList->setItemDelegate(conversationItemDelegate_);
