    ...
    menu_(new QMenu())
{
    ...
    // conversation list
    conversationItemDelegate_ = new ConversationItemDelegate(*ui->smartList);
...
CallWidget::updateSmartList()
{
    ...
    ui->smartList->setItemDelegate(new ConversationItemDelegate(*ui->smartList));
