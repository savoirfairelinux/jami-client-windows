...
CallWidget::navigated(bool to)
{
    ...
    if (LRCInstance::getActiveCalls().size()) {
        ...
        previewRenderer_->setGeometry(
            ui->videoWidget->width() - PreviewRenderWidget::previewMargin_ - ui->videoWidget->width() / 6,
            ui->videoWidget->height() - PreviewRenderWidget::previewMargin_ - ui->videoWidget->height() / 6,
            ui->videoWidget->width() / 6,
            ui->videoWidget->height() / 6
        );
