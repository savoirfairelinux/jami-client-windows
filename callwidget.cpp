...
void
CallWidget::setConversationFilter(lrc::api::profile::Type filter)
{
...
void
CallWidget::updateConversationsFilterWidget()
{
...
void
CallWidget::setConversationFilter(const QString& filter)
{
