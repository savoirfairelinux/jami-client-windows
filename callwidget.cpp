...
void CallWidget::slotShowIncomingCallView(const std::string& accountId,
    ...
    QFontMetrics callerBestNameNameFontMetrics(ui->callerBestNameLabel->font());
    QString elidedBestNameLabel = callerBestNameNameFontMetrics.elidedText(bestName, Qt::ElideRight, ui->callerBestNameLabel->width());
    ui->callerBestNameLabel->setText(elidedBestNameLabel);

    QFontMetrics callingBestNameFontMetrics(ui->callingBestNameLabel->font());
    elidedBestNameLabel = callingBestNameFontMetrics.elidedText(bestName, Qt::ElideRight, ui->callingBestNameLabel->width());
    ui->callingBestNameLabel->setText(elidedBestNameLabel);

    QFontMetrics bestIdFontMetrics(ui->callingBestIdLabel->font());
    QString elidedFinalBestId = bestIdFontMetrics.elidedText(finalBestId, Qt::ElideRight, ui->callingBestIdLabel->width());
    ui->callingBestIdLabel->setText(elidedFinalBestId);
}
