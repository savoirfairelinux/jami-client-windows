    ...
    imDelegate_(new ImDelegate())
{
    ...
    try {
        ...
        connect(&AccountModel::instance(), SIGNAL(accountEnabledChanged(Account*)),
        ...
        selectedAccountChanged(AccountModel::instance().selectionModel()->currentIndex(), QModelIndex());
...
CallWidget::selectedAccountChanged(const QModelIndex &current, const QModelIndex &previous)
{
    ...
    auto ac = current.data((int) Account::Role::Object).value<Account*>();
