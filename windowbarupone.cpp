...
, dl( QPoint() )
{
  ...
  minimize_ = addAction( QIcon( ":images/minimize-ring.png" ), "minimize" );

  maximize_ = addAction( QIcon( ":images/maximize-ring.png" ), "maximize" );

  quit_ = addAction( QIcon( ":images/close-ring.png" ), "quit" );
